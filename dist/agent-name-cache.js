...
async function loadAgentMap(ctx, companyId) {
    const now = Date.now();
 ...
 * already have.
 */
export async function resolveAgentName(ctx, companyId, agentId) {
    if (!agentId)
        return null;
    if (!companyId)
        return null;
 ...
 */
export function __resetAgentNameCache() {
    companyCaches.clear();
}
//# sourceMappingURL=agent-name-cache.js.map