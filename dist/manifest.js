    ...
    instanceConfigSchema: {
        ...
        properties: {
            ...
            agentNotesChannelId: {
                ...
                description: "Default channel for ad-hoc notes posted by agents via the discord_post_message tool. Falls back to the default channel.",
            ...
            parametersSchema: {
                ...
                properties: {
                    ...
                    kind: {
                        ...
                        description: "Semantic category that drives the embed color and title. Defaults to 'note' (blue). 'status' is green, 'question' is yellow, 'alert' is red.",
                    },
                    channelId: {
                        type: "string",
